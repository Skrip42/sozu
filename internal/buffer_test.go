...
func (s *SimpleFabricSuite) SetupTest() {
...
func (s *SimpleFabricSuite) TearDownTest() {
	goleak.VerifyNone(s.T())
}

func TestSimpleFabric(t *testing.T) {
	suite.Run(t, &SimpleFabricSuite{})
}

func (s *SimpleFabricSuite) TestWithAfterSendFlush() {
...
func (s *SimpleFabricSuite) TestWithBeforeSendFlush() {
	ctx, cancel := context.WithCancel(context.Background())
...
func (s *SimpleFabricSuite) TestWithClosedFlush() {
...
func (s *SimpleFabricSuite) TestWithClosedInput() {
	ctx, _ := context.WithCancel(context.Background())
...
func (s *SimpleFabricSuite) TestOk() {
	ctx, cancel := context.WithCancel(context.Background())
